      ...
      <div className="footer-grid">
        <div className="footer-brand">
          ...
          <div style={{display:"flex", gap:10, marginTop:6}}>
            <a href={APP_STORE_URL} target="_blank" rel="noopener noreferrer" className="btn btn-app" style={{padding:"10px 16px", fontSize:13}}>
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><a href={APP_STORE_URL} target="_blank" rel="noopener noreferrer">{t("nav.download")}</a></li>
