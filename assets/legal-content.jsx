const LEGAL_CONTENT = {
  terms: {
    en: {
      ...
      sections: [
        ...
        ["billing", "4. Subscriptions and Billing", ["Moss may offer optional paid features through Moss Pro. Purchases made through the Apple App Store are processed by Apple and are also governed by Apple's terms.", "Subscriptions renew automatically unless canceled at least 24 hours before the current period ends. You can manage or cancel subscriptions in your Apple ID subscription settings."]],
    ...
    tr: {
      ...
      sections: [
        ...
        ["billing", "4. Abonelikler ve Ödeme", ["Moss, Moss Pro aracılığıyla isteğe bağlı ücretli özellikler sunabilir. Apple App Store üzerinden yapılan satın almalar Apple tarafından işlenir ve Apple'ın şartlarına da tabidir.", "Abonelikler mevcut dönem bitmeden en az 24 saat önce iptal edilmezse otomatik yenilenir. Aboneliklerini Apple ID abonelik ayarlarından yönetebilir veya iptal edebilirsin."]],
  ...
  privacy: {
    en: {
      ...
      meta: "Last updated: June 2, 2026 · Effective June 2, 2026",
      intro: "This Privacy Policy explains how Moss handles information when you use the Moss app and website. Our principle is simple: collect as little as practical, keep data on your device when we can, and never sell your personal information.",
      sections: [
        ["collect", "1. Information We Collect", ["Account information, if you create an account, such as email address and optional name.", "Plant data you add, such as plant names, photos, care schedules, notes, and logs.", "Support messages you send us, including message contents and contact details.", "Limited device and diagnostic information, such as device model, operating system, app version, crash logs, approximate region, and basic usage events used to maintain and improve Moss."]],
        ["photos", "2. Plant Photos", ["Moss is designed to keep plant photos on your device whenever possible. Photos are not uploaded to our servers unless you choose a feature that requires sharing, such as support, community help, sync, backup, or a misidentification report."]],
        ["use", "3. How We Use Information", ["We use information to provide and improve Moss, identify plants, manage care reminders, respond to support requests, process subscriptions through Apple, protect against abuse, and comply with legal obligations. We do not use your personal information for targeted advertising."]],
        ["share", "4. Sharing", ["We share information only with service providers that help operate Moss, payment processors such as Apple for purchases, legal authorities when valid law requires it, and a successor if Moss is involved in a merger, acquisition, or asset transfer subject to comparable privacy commitments."]],
        ["retention", "5. Storage and Retention", ["Plant data stored locally stays on your device unless you enable a sync or sharing feature. Account and support information is kept only as long as needed for the purpose collected, legal compliance, backups, security, or fraud prevention, then deleted or anonymized."]],
        ["rights", "6. Your Rights", [<>Depending on where you live, you may ask to access, correct, delete, export, or restrict use of your personal information. To make a request, use the app settings where available or email <a href="mailto:mossplant@gmail.com">mossplant@gmail.com</a>. We aim to respond within 30 days.</>]],
        ["children", "7. Children", ["Moss is not directed to children under 13, and we do not knowingly collect personal information from children under 13. If you believe a child has provided personal information, contact us so we can delete it."]],
        ["international", "8. International Use", ["Moss is operated from Istanbul / Turkiye. If you use Moss from another country, your information may be processed where we or our service providers operate. We use appropriate safeguards when required for international transfers."]],
        ["security", "9. Security", ["We use reasonable administrative, technical, and organizational safeguards, including encryption in transit where applicable and access controls for systems that hold personal information. No method of storage or transmission is completely secure."]],
        ["changes", "10. Changes", ["We may update this policy. If changes are material, we will provide reasonable notice through the website, app, or email where available."]],
        ["contact", "11. Contact", [<>Privacy questions or requests: <a href="mailto:mossplant@gmail.com">mossplant@gmail.com</a>, Istanbul / Turkiye.</>]],
      ],
    },
    tr: {
      eyebrow: "Yasal",
      ...
      meta: "Son güncelleme: 2 Haziran 2026 · Yürürlük: 2 Haziran 2026",
      intro: "Bu Gizlilik Politikası, Moss uygulamasını ve web sitesini kullandığında bilgileri nasıl ele aldığımızı açıklar. İlkemiz basit: mümkün olduğunca az veri toplamak, mümkün olduğunda veriyi cihazında tutmak ve kişisel bilgilerini asla satmamak.",
      sections: [
        ["collect", "1. Topladığımız Bilgiler", ["Hesap oluşturursan e-posta adresi ve isteğe bağlı ad gibi hesap bilgileri.", "Eklediğin bitki adları, fotoğraflar, bakım programları, notlar ve kayıtlar gibi bitki verileri.", "Bize gönderdiğin destek mesajları, mesaj içeriği ve iletişim bilgileri.", "Moss'u sürdürmek ve geliştirmek için cihaz modeli, işletim sistemi, uygulama sürümü, çökme kayıtları, yaklaşık bölge ve temel kullanım olayları gibi sınırlı cihaz ve tanılama bilgileri."]],
        ["photos", "2. Bitki Fotoğrafları", ["Moss, mümkün olduğunda bitki fotoğraflarını cihazında tutacak şekilde tasarlanmıştır. Destek, topluluk yardımı, eşitleme, yedekleme veya yanlış tanıma bildirimi gibi paylaşım gerektiren bir özelliği seçmediğin sürece fotoğraflar sunucularımıza yüklenmez."]],
        ["use", "3. Bilgileri Nasıl Kullanırız", ["Bilgileri Moss'u sunmak ve geliştirmek, bitki tanımak, bakım hatırlatmalarını yönetmek, destek taleplerini yanıtlamak, Apple üzerinden abonelikleri işlemek, kötüye kullanımı önlemek ve yasal yükümlülüklere uymak için kullanırız. Kişisel bilgilerini hedefli reklam için kullanmayız."]],
        ["share", "4. Paylaşım", ["Bilgileri yalnızca Moss'u çalıştırmamıza yardımcı olan hizmet sağlayıcılarla, satın almalar için Apple gibi ödeme işlemcileriyle, geçerli hukuk gerektirdiğinde yetkili mercilerle ve Moss'un birleşme, satın alma veya varlık devri sürecinde benzer gizlilik taahhütlerine tabi haleflerle paylaşırız."]],
        ["retention", "5. Saklama ve Tutma", ["Yerel olarak saklanan bitki verileri, eşitleme veya paylaşım özelliğini etkinleştirmediğin sürece cihazında kalır. Hesap ve destek bilgileri toplandığı amaç, yasal uyum, yedekler, güvenlik veya dolandırıcılık önleme için gerektiği sürece tutulur; ardından silinir veya anonimleştirilir."]],
        ["rights", "6. Hakların", [<>Yaşadığın yere bağlı olarak kişisel bilgilerine erişme, düzeltme, silme, dışa aktarma veya kullanımını sınırlama talebinde bulunabilirsin. Talep için varsa uygulama ayarlarını kullanabilir veya <a href="mailto:mossplant@gmail.com">mossplant@gmail.com</a> adresine yazabilirsin. 30 gün içinde yanıtlamayı hedefleriz.</>]],
        ["children", "7. Çocuklar", ["Moss 13 yaş altındaki çocuklara yönelik değildir ve 13 yaş altındaki çocuklardan bilerek kişisel bilgi toplamayız. Bir çocuğun kişisel bilgi verdiğini düşünüyorsan silmemiz için bizimle iletişime geç."]],
        ["international", "8. Uluslararası Kullanım", ["Moss İstanbul / Türkiye'den işletilir. Moss'u başka bir ülkeden kullanırsan bilgilerin bizim veya hizmet sağlayıcılarımızın faaliyet gösterdiği yerlerde işlenebilir. Uluslararası aktarımlar için gerektiğinde uygun güvenceler kullanırız."]],
        ["security", "9. Güvenlik", ["Uygun olduğu yerde aktarım sırasında şifreleme ve kişisel bilgi içeren sistemler için erişim kontrolleri dahil olmak üzere makul idari, teknik ve organizasyonel önlemler kullanırız. Hiçbir saklama veya aktarım yöntemi tamamen güvenli değildir."]],
        ["changes", "10. Değişiklikler", ["Bu politikayı güncelleyebiliriz. Değişiklikler önemliyse web sitesi, uygulama veya mevcutsa e-posta yoluyla makul bildirim yaparız."]],
        ["contact", "11. İletişim", [<>Gizlilik soruları veya talepleri: <a href="mailto:mossplant@gmail.com">mossplant@gmail.com</a>, İstanbul / Türkiye.</>]],
      ],
    },
  },
  eula: {
...
function LegalArticle({ page }) {
  ...
  return (
    <article className="article">
      ...
      <p className="legal-note">{language === "tr" ? "Bu metin genel bilgilendirme amaçlıdır; yayınlamadan önce hukuki danışmanlık almanı öneririz." : "This text is provided for general information; consider legal review before publication."}</p>
    </article>
  );
}
